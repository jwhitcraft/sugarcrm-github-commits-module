...
$key = (isset($sugar_config['github_key'])) ? $sugar_config['github_key'] : '';
$sugar_smarty->assign('GITHUB_KEY', $key);

$sugar_smarty->assign('GITHUB_URL', $sugar_config['site_url'] . 'GitPostPushCapture.php?key=' . $key);
