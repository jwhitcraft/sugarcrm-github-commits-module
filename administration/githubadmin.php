...
$admin_option_defs['Administration']['github_configration']=array('Administration','LBL_GITHUB_USERCONFIG','LBL_GITHUB_USERCONFIG_DESC','./index.php?module=githb_commits&action=UserConfig');
